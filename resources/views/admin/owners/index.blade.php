                  ...
                  <thead>
                    <tr>
                      <th
                        ...
                        名前</th>
                      <th class="md:md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                        メールアドレス</th>
                      <th class="md:md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">作成日
                      </th>
                      <th
                        class="md:md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br">
                      </th>
                      <th
                        class="md:md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br">
                      </th>
                    ...
                    <tr>
                      ...
                      <form id="delete_{{$owner->id}}" method="post"
                        ...
                        <td class="md:px-4 py-3">
                          <a data-id="{{ $owner->id }}" href="#" onclick="deletePost(this)"
