        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="post" action="{{ route('owner.products.update', ['product' => $product->id ])}}">
            ...
            <div class="-m-2">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <select name="category" id="category"
                    ...
                    <optgroup label="{{ $category->name }}" @if($category->id === $product->secondary_category_id)
                      selected @endif>
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative flex justify-around">
                  <div><input type="radio" name="is_selling" value="1" class="mr-2" @if($product->is_selling ===
                    1)checked @endif>販売中</div>
                  <div><input type="radio" name="is_selling" value="0" class="mr-2" @if($product->is_selling ===
                    0)checked @endif>停止中</div>
                </div>
              </div>
